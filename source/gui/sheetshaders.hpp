...
#pragma clang diagnostic ignored "-Wexit-time-destructors"
    ...
    const std::string Sheet::vertexShaderGL2_=
      ...
      "  else{color = vec4(clamp(2*p,0,1),clamp(2-abs(2*p*p),0,1),clamp(-2*p,0,1),1);}\n"
      "  return color;\n"
      "}\n"
    ...
    const std::string Sheet::fragmentShaderGL2_=
      ...
      "      float k1=clamp(dot(normal_,vec3(1,1,1)),0,1);\n"
      "      float k2=abs(acos(dot(normalize(vec3(1,1,1)+view),normal_))/0.07);\n"
      "      k2=exp(-k2*k2);\n"
      "      gl_FragColor=rgba2_*(0.4+k1*0.6)+(rgba2_*0.2+vec4(1,1,1,1)*0.8)*k2;\n"
      "    }\n"
    ...
    const std::string Sheet::fragmentShaderGL3_=
      ...
      "      float k2=abs(acos(dot(normalize(vec3(1,1,1)+view),normal_))/0.07);\n"
      "      k2=exp(-k2*k2);\n"
      "      color_=rgba2_*(0.4+k1*0.6)+(rgba2_*0.2+vec4(1,1,1,1)*0.8)*k2;\n"
      "    }\n"
